...
use syn::{self, GenericArgument, Ident, Path, PathArguments, Type, TypePath};
...
fn generate_builder_struct_fields(
    builder_fields: &Vec<BuilderField>,
...
fn generate_builder_default_fields(
    builder_fields: &Vec<BuilderField>,
) -> Vec<proc_macro2::TokenStream> {
    builder_fields
        .iter()
...
fn generate_builder_iterative_setters(
    builder_fields: &Vec<BuilderField>,
) -> Vec<proc_macro2::TokenStream> {
    builder_fields.iter()
...
fn generate_build_property_replaces(
    builder_fields: &Vec<BuilderField>,
) -> Vec<proc_macro2::TokenStream> {
    builder_fields.iter()
